...
- Renommer conceptuellement "Dossiers" en "Dossiers de politique".
- Ajouter une table `statut_workflow` (Brouillon, En révision, Signé) et la lier à la table `dossiers`.
...
- Modèles : Mettre à jour `Dossier.php` pour gérer le statut du workflow, les fichiers associés et les partages.
- Contrôleurs : Ajouter la logique d'upload de fichiers (PDF, PPT) dans `DossierController.php`.
...
- Remplacer les termes "Dossier" par "Dossier" et "Tâche" par "Action" dans toute l'interface.
