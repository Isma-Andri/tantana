...
// Barre de navigation principale (affichée uniquement si connecté)
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-1">
                <a href="projets"
                   class="px-4 py-2 rounded-lg text-sm font-medium text-ink-500 hover:text-ink hover:bg-ink-50 transition-colors">
                    Projets
                </a>
                <?php if ($isChef): ?>
                <a href="projets/create"
                   class="px-4 py-2 rounded-lg text-sm font-medium text-jade hover:bg-jade-light transition-colors">
                    + Nouveau projet
                </a>
                <?php endif; ?>
            </div>
