    ...
    <div class="bg-white rounded-2xl shadow-card overflow-hidden">
        ...
        <form action="projets/create" method="POST" class="p-8 space-y-6" novalidate>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-ink mb-1.5" for="date_limite">
                        Date limite
                        <span class="text-xs font-normal text-rose">(deadline)</span>
                    </label>
                    <input type="date" id="date_limite" name="date_limite" class="t-input"
                           value="<?= e($_POST['date_limite'] ?? '') ?>">
                </div>
            </div>
