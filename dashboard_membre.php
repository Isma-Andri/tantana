  ...
  <main class="main-content">
    <div class="page-header fade-up">
      <div style="display:flex;align-items:center;justify-content:space-between;">
        <div>
          ...
          <p>Voici votre espace de travail personnel.</p>
        </div>
    ...
    <div class="grid-2 fade-up delay-2">
      ...
      <div class="card">
        <div class="card-header">
          <span class="card-title">Mes tâches récentes</span>
          <span class="badge badge-orange">À venir</span>
        </div>
        <div style="text-align:center;padding:40px 0;color:var(--text-muted);">
          <div style="font-size:2.5rem;margin-bottom:12px;">✅</div>
          <p style="font-size:.9rem;">Aucune tâche assignée pour l'instant.<br>Votre chef de projet vous en attribuera bientôt.</p>
        </div>
      </div>
        ...
        <div style="display:flex;flex-direction:column;gap:16px;padding-top:8px;">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:8px;">
            <div style="background:var(--bg3);border-radius:var(--radius-sm);padding:12px;">
              <div style="font-size:.75rem;color:var(--text-muted);margin-bottom:4px;text-transform:uppercase;letter-spacing:.06em;">Rôle</div>
    ...
    <div class="card mt-24 fade-up delay-3">
      <div class="card-header">
        ...
        <span class="badge badge-blue">Module à venir</span>
      </div>
      <div style="text-align:center;padding:40px 0;color:var(--text-muted);">
        <div style="font-size:2.5rem;margin-bottom:12px;">📁</div>
        <p style="font-size:.9rem;">Vous n'êtes encore assigné à aucun projet.<br>Votre chef de projet vous ajoutera à un projet prochainement.</p>
      </div>
    </div>
  </main>
</div>
